...
echo "------------------------------------------------------------------------------"
echo "cp $template_dir/iot-device-simulator.yaml $template_dist_dir/iot-device-simulator-china.template"
cp $template_dir/iot-device-simulator-china.yaml $template_dist_dir/iot-device-simulator-china.template

echo "Updating code source bucket in template with $1"
replace="s/%%BUCKET_NAME%%/$1/g"
echo "sed -i '' -e $replace $template_dist_dir/iot-device-simulator-china.template"
sed -i '' -e $replace $template_dist_dir/iot-device-simulator-china.template
...
echo "------------------------------------------------------------------------------"
echo "[Rebuild] Services - OpenID Token"
echo "------------------------------------------------------------------------------"
cd $source_dir/services/openidtoken
npm run build
cp ./dist/iot-sim-openidtoken-service.zip $build_dist_dir/iot-sim-openidtoken-service.zip
